...
% This is an implementation Furry-Rough Quick Reduct algorithm
...
%%================================Data=====================================
strArray = cell(4,1);
strArray{1} = 'Data/wine.csv';
strArray{2} = 'Data/heart.csv';
strArray{3} = 'Data/sonar.csv';
strArray{4} = 'Data/diabets.csv';
...
for i = 1:1
    ...
    while(true)
        ...
        if ((~isempty(maxDD)) && (max(fDD) < max(maxDD(2,:))))
            [~, mxF] = max(maxDD(2, :));
